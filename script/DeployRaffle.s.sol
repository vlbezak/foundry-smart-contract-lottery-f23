...
import {CreateVRFSubscription, FundVRFSubscription, AddVRFConsumer} from "./Interactions.s.sol";
...
contract DeployRaffle is Script {
    function run() external returns (Raffle, HelperConfig) {
        ...
        if(subscriptionId == 0){
            ...
            fundVRFSubscription.fundSubscription(vrfCoordinator, subscriptionId, link, deployerKey);
        ...
        addVRFConsumer.addConsumer(address(raffle), vrfCoordinator, subscriptionId, deployerKey);
